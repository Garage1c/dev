...
Функция ПолучитьОстаткиТоваровВПути(БП_Сборка, СкладОтправитель, СкладПолучатель)
	...
	Запрос.Текст = "Выбрать ЗаказЧик.заказ заказ, Номенклатура, Упаковка, КоличествоОстаток Принять, КоличествоОстаток Количество, КоличествоОстаток МаксимальноеКоличество из РегистрНакопления.ТоварыВПути.Остатки(,Заказчик = &Заказчик и СкладОтправитель = &СкладОтправитель и СкладПолучатель = &СкладПолучатель)";
