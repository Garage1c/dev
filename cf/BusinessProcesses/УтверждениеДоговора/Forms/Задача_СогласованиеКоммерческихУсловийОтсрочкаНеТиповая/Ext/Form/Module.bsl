...
Процедура КоммерческиеУсловияСогласованы(Команда)
	...
	Если 	КоммерческиеУсловияСогласоватьНаСервере(Истина) И
...
Процедура КоммерческиеУсловияНеСогласованы(Команда)
	...
	Если 	КоммерческиеУсловияСогласоватьНаСервере(Ложь) И
		ВыполнитьЗадачуНаСервере() Тогда
...
&НаСервере
Функция КоммерческиеУсловияСогласоватьНаСервере(РезультатСогласования)
