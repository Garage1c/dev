...
Процедура ТекстДоговораСогласован(Команда)
	...
	Если 	ТекстДоговораСогласованиеНаСервере(Истина) И
...
Процедура ТекстДоговораНеСогласован(Команда)
	...
	Если 	ТекстДоговораСогласованиеНаСервере(Ложь) И
		ВыполнитьЗадачуНаСервере() Тогда
...
&НаСервере
Функция ТекстДоговораСогласованиеНаСервере(РезультатСогласования)
	
	Процесс = Объект.БизнесПроцесс.ПолучитьОбъект();
	Процесс.СогласованоСКлиентом = РезультатСогласования;
