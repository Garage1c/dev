...
Процедура ТребуетсяОплатаПроверкаУсловия(ТочкаМаршрутаБизнесПроцесса, Результат)
	...
	//	а также известен основной менеджер контрагента, то именно он будет контролировать оплату
...
Процедура ПроверитьОплатуПроверкаУсловия(ТочкаМаршрутаБизнесПроцесса, Результат)
	...
	// Стартуем ОжиданиеОплаты1 для случая, когда контрагенту не назначен основной менеджер.
