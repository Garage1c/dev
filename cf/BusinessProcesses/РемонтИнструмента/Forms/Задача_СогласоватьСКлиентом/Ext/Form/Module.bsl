...
Процедура УстановитьОтветственногоПоОплате(Процесс)
	...
	// Сохраним значение основного менеджера, дальнейшее изменение значения ОсновнойМенеджер у Партнера не должно повлиять на ход БизнесПроцесса
...
Функция СохранитьДанныеЗадачи(ВариантСогласования)
	...
	// если клиент отказался от ремонта или согласился с условиями, запишем ему менеджера (если сумма заказ не нулевая и партнеру назначен менеджер)
