...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//Запрос = Новый Запрос("
	//|ВЫБРАТЬ Ссылка Участник ИЗ Справочник.Партнеры ГДЕ Ссылка = &Партнер ОБЪЕДИНИТЬ
	//|ВЫБРАТЬ Ссылка ИЗ Справочник.ГруппыПартнеров.Состав ГДЕ Партнер = &Партнер");
	//		
	//Запрос.УстановитьПараметр("Партнер", Партнер);
	//
	//Участники = Запрос.Выполнить().Выгрузить().ВыгрузитьКолонку("Участник");
		
	// если в документе нет Акции, тогда записи с акцией для участника не нужны, они будут давать ложные данные при определении цены
	//Список.Параметры.УстановитьЗначениеПараметра("ФильтрПоУчастникам",	СтруктураКолонокТовары.ЕстьАкция);
	//Список.Параметры.УстановитьЗначениеПараметра("Участники", 			Участники);
