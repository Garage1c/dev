...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИспользоватьSSLPOP3 = УчетнаяЗаписьСтруктура.ИспользоватьSSLPOP3;
	ИспользоватьSSLSMTP = УчетнаяЗаписьСтруктура.ИспользоватьSSLSMTP;
...
Функция ЗаполнитьДополнительныеПараметры()
	...
	Результат.Вставить("ИспользоватьSSLPOP3", ИспользоватьSSLPOP3);
	Результат.Вставить("ИспользоватьSSLSMTP", ИспользоватьSSLSMTP);
