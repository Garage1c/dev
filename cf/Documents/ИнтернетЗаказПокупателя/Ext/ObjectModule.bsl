...
Процедура ПриЗаписи(Отказ)
	...
	//синхронное изменение партнера и контрагента в документе оплаты
	Запрос=Новый Запрос;
	...
	Запрос.Текст="ВЫБРАТЬ
	             ...
	             |	ОплатаЭлектроннымиДеньгами.Партнер
	             |ПОМЕСТИТЬ ВТ
	             |ИЗ
	...
	Если Не Рез.Пустой() тогда
		...
		Исключение
			Отказ=Истина;
			Сообщить("Не удалось записать контрагента и партнера в Оплату электронными деньгами! "+ОписаниеОшибки());
		КонецПопытки	
	КонецЕсли;	
