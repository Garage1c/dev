...
Функция ПолучитьТаблДокумент(Ссылки)
	...
	Запрос = Новый Запрос("ВЫБРАТЬ Ссылка ИЗ Документ.ТехЗаключение ГДЕ ЗаказНаряд В(ВЫБРАТЬ ЗаказНаряд ИЗ БизнесПроцесс.РемонтИнструмента ГДЕ Ссылка В(&Ссылки)) И Не ПометкаУдаления");
