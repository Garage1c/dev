...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	Если ТипЗнч = Тип("ДокументСсылка.ЗаказПоставщику") Тогда	
		...
		Запрос = Новый Запрос("
			|ВЫБРАТЬ РАЗРЕШЕННЫЕ
			|	Организация, Контрагент, Склад, ТипЦен, Валюта, УчитыватьНДС, СуммаВключаетНДС
			|ИЗ
	...
	ИначеЕсли ТипЗнч = Тип("ДокументСсылка.Инвойс") Тогда
		...
		Запрос = Новый Запрос("
			|ВЫБРАТЬ РАЗРЕШЕННЫЕ
			|	Ссылка Инвойс, Организация, Контрагент, Склад, ТипЦен, Валюта, УчитыватьНДС, СуммаВключаетНДС
			|ИЗ
			|	Документ.Инвойс
			|ГДЕ
			|	Ссылка = &Ссылка");
