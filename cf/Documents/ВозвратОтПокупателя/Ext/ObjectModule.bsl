...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	СтруктураКолонокТовары = Новый Структура("ЕстьКоличество, ЕстьЦена, ЕстьСуммаБезСкидки, ЕстьСумма, ЕстьСуммаАвтоматическойСкидки, ЕстьСуммаРучнойСкидки, ЕстьСтавкаНДС, ЕстьСуммаНДС, СуммаВключаетНДС, ЕстьВсего, ЕстьАкция, УчитыватьНДС, ЕстьУпаковка, ЕстьКоличествоВУпаковке, ТипЦен, Валюта, Партнер, ЕстьПроцентРучнойСкидки, ЕстьПроцентАвтоматическойСкидки",
												Истина, Истина, Ложь, Истина, Истина, Истина, Истина, Истина, Истина, Ложь, Истина, ДанныеЗаполнения.Ссылка.УчитыватьНДС, Истина, Истина, ДанныеЗаполнения.Ссылка.ТипЦен, ДанныеЗаполнения.Ссылка.Валюта, ДанныеЗаполнения.Ссылка.Партнер, Истина, Истина);
