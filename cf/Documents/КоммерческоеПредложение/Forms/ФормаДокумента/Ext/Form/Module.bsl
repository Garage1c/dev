...
Процедура РассчитатьПроцентАвтоматическойСкидки(Строка)
	...
	Строка.ПроцентАвтоматическойСкидки = РаботаСНоменклатурой.ПолучитьПроцентАвтоматическойСкидки(Строка.Номенклатура, Объект.Партнер);
...
Процедура ТоварыНоменклатураПриИзменении(Элемент)
	...
	Если ТипЗнч(текСтрока.Номенклатура) = Тип("СправочникСсылка.Номенклатура") И Не текСтрока.Номенклатура.Пустая() Тогда
		...
		//РассчитатьСуммыСтрокиОтЦены(СтрокаТаблицы, СтруктураКолонокТовары, ПересчитатьЦену = Истина)
		...
		//текСтрока.ПроцентАвтоматическойСкидки = РаботаСНоменклатурой.ПолучитьПроцентАвтоматическойСкидки(текСтрока.Номенклатура, Объект.Партнер);
		//ОбновитьЦенуСтроки(текСтрока); 
	КонецЕсли;
...
Процедура КонтрагентПриИзменении(Элемент)
	...
	Партнер = ПолучитьПартнера(Объект.Контрагент);
	ПартнерПриИзменении("");
