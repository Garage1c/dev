...
//	
//	Возврат Объект.ВидОперации <> Перечисления.ВидыОперацийПКО.ПрочийПриход И Объект.Партнер.Пустая();
//	
//КонецФункции
...
Процедура УправлениеВидимостьюДоступностью()
	...
	//Элементы.Партнер.ОтметкаНезаполненного  = НЕ ПрочийПриход И Объект.Партнер.Пустая();
	//Элементы.Партнер.Видимость = не ПрочийПриход;
