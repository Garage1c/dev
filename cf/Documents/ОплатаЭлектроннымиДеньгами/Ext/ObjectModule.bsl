...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	Если ТипОсн = Тип("БизнесПроцессСсылка.ИнтернетЗаявка") Тогда
		...
		ЗаполнитьЗначенияСвойств(ЭтотОбъект, ИнтернетЗаказПокупателя, "Валюта, Контрагент, СуммаВключаетНДС, УчитыватьНДС");
	...
	ИначеЕсли
		...
		ЗаполнитьЗначенияСвойств(ЭтотОбъект, ДанныеЗаполнения, "Валюта, Контрагент, СуммаВключаетНДС, УчитыватьНДС");
		ВидОперации = Перечисления.ВидыОперацийЧекККМ.Продажа;
