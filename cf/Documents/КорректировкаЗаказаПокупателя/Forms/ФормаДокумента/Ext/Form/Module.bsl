...
Процедура ЗаполнитьСтавкуНДС(Команда)
	...
	ДиалогиСПользователем.ЗаполнитьСтавкуНДС(Объект.Товары);
...
&НаКлиенте
Процедура ЗаказТипЦенПриИзменении(Элемент)
	
	Если ФункцииФормДокументов.ДиалогПриИзмененииТипаЦен(Объект.Товары.Количество()) Тогда
