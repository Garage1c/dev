...
Процедура ЗаполнитьРеквизитыШапкиСчетФактура(ДанныеПечати, СведенияОПоставщике, Макет, ТабличныйДокумент, Номер, Дата, ПечатьВВалюте, ЭтоСчетФактураНаАванс)
	...
	// + neti Муталлапова 09.06.2017
	ОбластьМакета.Параметры.ИдентификаторГосударственногоКонтракта = "Идентификатор государственного контракта, договора (соглашения): " 
																		+ ?(ЗначениеЗаполнено(ДанныеПечати.ИдентификаторГосударственногоКонтракта),
																			ДанныеПечати.ИдентификаторГосударственногоКонтракта,
																			"-------------");
	// - neti Муталлапова 09.06.2017
