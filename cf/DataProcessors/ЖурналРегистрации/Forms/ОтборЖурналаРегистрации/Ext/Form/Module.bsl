...
Процедура ПередЗакрытием(Отказ, СтандартнаяОбработка)
	...
	Параметры.Отбор = ОтборЖурналаРегистрации;
КонецПроцедуры

&НаКлиенте
Процедура Важность_УстановитьВсе()
	Важность.ЗаполнитьПометки(Истина);
КонецПроцедуры

&НаКлиенте
Процедура Важность_СнятьВсе()
	Важность.ЗаполнитьПометки(Ложь);
КонецПроцедуры

&НаКлиенте
Процедура СтатусТранзакции_УстановитьВсе()
	СтатусТранзакции.ЗаполнитьПометки(Истина);
КонецПроцедуры

&НаКлиенте
Процедура СтатусТранзакции_СнятьВсе()
	СтатусТранзакции.ЗаполнитьПометки(Ложь);
КонецПроцедуры

&НаКлиенте
Процедура ИсполнениеВыбора(Элемент, СтандартнаяОбработка)
	...
	Если ФормаРедактора.ОткрытьМодально() = КодВозвратаДиалога.ОК Тогда
		ФормаРедактора.ПолучитьОтредактированныйСписок(РедактируемыйСписок);
	КонецЕсли;
КонецПроцедуры
