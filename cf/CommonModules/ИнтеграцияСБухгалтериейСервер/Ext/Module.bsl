...
Функция Получить_ДокументСчетФактураПолученный(Connector, СсылкаНаОбъект, ПеренесенныеОбъекты, стрОшибки = "")
	...
	|	ДокументОснование.Контрагент  Контрагент,
	|	ВЫБОР КОГДА ДокументОснование.Контрагент.ЭтоКонтрагентБухгалтерии ТОГДА ДокументОснование.Контрагент ИНАЧЕ НЕОПРЕДЕЛЕНО КОНЕЦ ДоговорКонтрагента,
 	|	НомерВходящегоДокумента,
	|	ДатаВходящегоДокумента,
	|	ДокументОснование,
