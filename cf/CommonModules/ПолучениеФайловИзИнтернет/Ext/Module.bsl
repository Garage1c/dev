...
Функция СкачатьФайлНаСервере(знач URL,
	...
	Результат = ПолучениеФайловИзИнтернетКлиентСервер.ПодготовитьПолучениеФайла(
	                 URL,
	                 Пользователь,
	                 Пароль,
	                 Порт,
...
Процедура ЗаписатьОшибкуВЖурналРегистрации(знач СообщениеОбОшибке) Экспорт
	...
	ЗаписьЖурналаРегистрации("Получение файлов из интернет", УровеньЖурналаРегистрации.Ошибка, , , СообщениеОбОшибке);
