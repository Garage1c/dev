...
Функция JSON36(Значение, ЗначениеВXML = Ложь) Экспорт
	...
	НастройкаСериализации.СериализовыватьМассивыКакОбъекты 	= Истина;
...
КонецФункции
Функция UnJSON36(стрJSON, ДополнительныеПараметры, стрОшибки = "") Экспорт
	
	Чтение = Новый ЧтениеJSON;
	Чтение.УстановитьСтроку(стрJSON);
	
	Попытка
		Возврат ПрочитатьJSON(Чтение, Ложь,,,"ПреобразованиеЧтенияJSON", w1_Json, ДополнительныеПараметры);
	Исключение
