...
Функция ПодготовитьПолучениеФайла(знач URL,
	...
	НастройкаПроксиСервера = ПолучениеФайловИзИнтернет.ПолучитьНастройкуПроксиСервера();
	#Иначе
...
Функция ПолучитьФайлИзИнтернет(знач URL,
	...
	Если Протокол = "ftp" Тогда
		...
		Исключение
			...
			СообщениеОбОшибке = НСтр("ru = 'Во время создания FTP соединения произошла ошибка.'")
											 + Символы.ПС
											 + ОбщегоНазначенияКлиентСервер.ПолучитьПредставлениеОписанияОшибки(ИнформацияОбОшибке);
			ПолучениеФайловИзИнтернет.ЗаписатьОшибкуВЖурналРегистрации(СообщениеОбОшибке);
	...
	Иначе
		...
		Исключение
			ИнформацияОбОшибке = ИнформацияОбОшибке();
			СообщениеОбОшибке = НСтр("ru = 'Во время создания HTTP соединения произошла ошибка.'")
											 + Символы.ПС
											 + ОбщегоНазначенияКлиентСервер.ПолучитьПредставлениеОписанияОшибки(ИнформацияОбОшибке);
			ПолучениеФайловИзИнтернет.ЗаписатьОшибкуВЖурналРегистрации(СообщениеОбОшибке);
			Возврат СформироватьРезультат(Ложь, СообщениеОбОшибке);
