...
Процедура НоменклатураПриИзменении(	ТабличнаяЧастьТовары, 
	...
	Если ТекДанные <> Неопределено Тогда
		...
		Если СтруктураКолонокТовары.Свойство("БольшеНеПоставляется") И СтруктураКолонокТовары.ЕстьБольшеНеПоставляется Тогда ТекДанные.БольшеНеПоставляется = ОбщегоНазначения.ПолучитьЗначениеРеквизита(ТекДанные.Номенклатура,"БольшеНеПоставляется"); КонецЕсли;
