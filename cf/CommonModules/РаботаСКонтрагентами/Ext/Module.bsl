Процедура ЗаполнитьСписокВариантовДоставкиДляПокупки(СписокВариантовДоставки) Экспорт
	...
	СписокВариантовДоставки.Добавить(Перечисления.ВариантДоставки.ДоставкаДоСкладаПоставщиком, Строка(Перечисления.ВариантДоставки.ДоставкаДоСкладаПоставщиком));
	СписокВариантовДоставки.Добавить(Перечисления.ВариантДоставки.ДоставкаДоСкладаТК, Строка(Перечисления.ВариантДоставки.ДоставкаДоСкладаТК));
