...
// Получаем представление контактной информации
//
// Параметры:
//  Ссылка - Составной - Объект для получения контактной информации
//  ВидКонтактнойИнформации - СправочникСсылка.ВидКонтактнойИнформации  - Группа контактной информации для отбора
//
// Возвращаемое значение:
//   Строка - Представление контактной информации
//
Функция ПолучитьПредставлениеКонтактнойИнформацииОбъектаВидГруппа(Ссылка, ВидКонтактнойИнформации) Экспорт 
	
	ТекстЗапроса = "ВЫБРАТЬ РАЗРЕШЕННЫЕ
	               |	ПредставлениеКонтактнойИнформации.Представление,
	               |	ПредставлениеКонтактнойИнформации.ЗначениеПоУмолчанию КАК ЗначениеПоУмолчанию
	               |ИЗ
	               |	РегистрСведений.ПредставлениеКонтактнойИнформации КАК ПредставлениеКонтактнойИнформации
	               |ГДЕ
	               |	ПредставлениеКонтактнойИнформации.Объект = &Ссылка
...
КонецФункции // ПолучитьПредставлениеКонтактнойИнформацииОбъекта()
