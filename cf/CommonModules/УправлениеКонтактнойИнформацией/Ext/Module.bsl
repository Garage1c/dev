...
Функция ПолучитьКарточкуКонтактаHTML(Ссылка, Справочник) Экспорт
	...
	Если Справочник = "Партнеры" Тогда
		СформироватьКарточкуКонтактаHTML(Текст, Ссылка, Справочник, 
											...
											"Родитель", "НаименованиеПолное", "Комментарий");	
		
	ИначеЕсли Справочник = "Контрагенты" Тогда
		//СформироватьКарточкуКонтактаHTML(Текст, Ссылка, Справочник, 
		//									Новый Структура ("СправочникВложение, РеквизитСвязи, ДопРеквизитВложения",
		//												"ФизическиеЛица", "ФизЛицо", "ДатаРождения"),
		//									"Партнер", "НаименованиеПолное", "Комментарий", Новый Структура("ЮрФизЛицо, ИНН, КПП, КодПоОКПО"));	
...
&НаСервере
Функция ПартнерПриИзменении(Ссылка) Экспорт
	...
	Запрос = Новый Запрос("ВЫБРАТЬ ПЕРВЫЕ 1
							...
							|ГДЕ
							|	Партнер = &Ссылка И НЕ ПометкаУдаления
							|УПОРЯДОЧИТЬ ПО
							|	ЗначениеПоУмолчанию");
