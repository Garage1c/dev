...
Процедура ПриОткрытии(Отказ)
	...
	Если РеквизитыВладельца.Найти("Партнер") <> Неопределено И Элементы.Найти("Контаргент") <> Неопределено Тогда
		НовыйПараметр = Новый ПараметрВыбора("Отбор.Партнер", ВладелецФормы.Объект.Партнер);
