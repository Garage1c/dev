...
Процедура СохранитьНастройки(Массив, Заголовок)
	...
	РаботаСНоменклатурой.ОбновитьНастройкиОперативнойИнфоОТоваре(Новый Структура("Склады, ТипыЦен, Остатки, Цены, ВнутренниеЗаказы", Склады, ТипыЦен, Остатки, Цены, ВнутренниеЗаказы));
	
	// обновляем флажки
	Заголовок = РаботаСНоменклатурой.СформироватьЗаголовокТовараHTML(Массив, Остатки, Цены, ВнутренниеЗаказы);
...
Процедура ПриЗакрытии()
	...
	Массив = РаботаСНоменклатуройКлиент.ПолучитьМассивВыделенныхТоваров(ВладелецФормы, ТоварыЭлемент, ТоварыФорма);
	...
	Валюта = ?(ВладелецФормы.Элементы.Найти("Валюта") = Неопределено, КэшируемыеФункции.ВалютаУправленческогоУчета(), ВладелецФормы.Валюта);
