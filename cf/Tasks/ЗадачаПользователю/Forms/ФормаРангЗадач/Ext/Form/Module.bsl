...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОтделОРСТП = Справочники.ТипыОтделов.НайтиПоКоду("000000004"); //HARDCODE
	Список.Параметры.УстановитьЗначениеПараметра("ОтделОРСТП", ОтделОРСТП);
	
	РегионСПБ = Справочники.Регионы.НайтиПоКоду("78    ");    //HARDCODE
	Список.Параметры.УстановитьЗначениеПараметра("РегионСПБ", РегионСПБ);
