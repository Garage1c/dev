...
Процедура ПриОткрытии(Отказ)
	...
	Если Не НеОткрыватьДругуюФорму Тогда
		...
		Иначе	
			...
			КонвертацияТипов.ДобавитьВСтруктуруСтруктуру(Структурапараметров, ПараметрыДляДобавления);
			
			ОткрытьФорму(ИмяОткрФормы, Структурапараметров, ВладелецФормы,, Окно);
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПараметрыДляДобавления = Новый Структура("ЗаказыДляОбъединения", Параметры.ЗаказыДляОбъединения);
